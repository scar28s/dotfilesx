...
awful.spawn.with_shell("~/.config/awesome/mouse_fix.sh")

-- Set middle monitor refresh rate to 144
awful.spawn.with_shell("xrandr --output DP-0 --mode 2560x1440 --rate 143.91")
awful.spawn.with_shell("xrandr --output HDMI-0 --mode 1920x1080 --rate 99.65")
awful.spawn.with_shell("xrandr --output HDMI-1 --mode 1920x1080 --rate 99.65")
